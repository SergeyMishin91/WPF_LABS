...
namespace Lab7 {
    ...
    public partial class LAB7DataSet : global::System.Data.DataSet {
        ...
        public partial class DoctorsDataTable : global::System.Data.TypedTableBase<DoctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DoctorsRow AddDoctorsRow(string FirstName, string LastName, string Specialization, int VisitCost, int Experience) {
            ...
            private void InitClass() {
                ...
                this.columnVisitCost = new global::System.Data.DataColumn("VisitCost", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class DoctorsRow : global::System.Data.DataRow {
            ...
            public int VisitCost {
                get {
                    return ((int)(this[this.tableDoctors.VisitCostColumn]));
                }
                set {
                    this[this.tableDoctors.VisitCostColumn] = value;
                }
            }
...
namespace Lab7.LAB7DataSetTableAdapters {
    ...
    public partial class DoctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctors] ([FirstName], [LastName], [Specialization], [VisitCos" +
                "t], [Experience]) VALUES (@FirstName, @LastName, @Specialization, @VisitCost, @E" +
                "xperience)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@VisitCost", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "VisitCost", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab7.Properties.Settings.Default.LAB7ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT FirstName, LastName, Specialization, VisitCost, Experience FROM dbo.Doctor" +
                "s";
        ...
        public virtual int Fill(LAB7DataSet.DoctorsDataTable dataTable) {
        ...
        public virtual LAB7DataSet.DoctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LAB7DataSet.DoctorsDataTable dataTable = new LAB7DataSet.DoctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LAB7DataSet.DoctorsDataTable dataTable) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Specialization, int VisitCost, int Experience) {
            if ((FirstName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(VisitCost));
